...
def generate_mdvrp_data(dataset_size, vrp_size):
    CAPACITIES = {
        10: 20.,
        20: 30.,
        50: 40.,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--problem", type=str, default='all',
                        help="Problem, 'tsp', 'vrp', 'pctsp', 'mdvrp' or 'op_const', 'op_unif' or 'op_dist'"
    ...
    parser.add_argument('--graph_sizes', type=int, nargs='+', default=[10, 20, 50, 100],
                        help="Sizes of problem instances (default 10 20, 50, 100)")
